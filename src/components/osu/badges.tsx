...
/**
 * A player's country, drawn as a two-letter code chip.
 *
 * Emoji flags were the obvious choice here and are the wrong one: they
 * render as empty boxes on any system without an emoji font, which
 * includes plenty of Linux desktops and every bare server. A code chip
 * always renders, stays legible at table density, and carries the full
 * country name for assistive technology.
 */
